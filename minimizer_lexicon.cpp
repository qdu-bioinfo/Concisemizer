// minimizer_lexicon sampling
// compile：g++ -std=c++11 minimizer_lexicon.cpp -o minimizer_lexicon
// operation：./minimizer_lexicon -n XXX.fna -k xxx -w xxx
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 7)
    {
        std::cout << "Error: No arguments provided." << std::endl
                  ...
                  << "./minimizer_lexicon -n XXX.fna -k xxx -w xxx" << std::endl
                  << std::endl;
        return 0;
    }
    // Obtain option
    ...
    // H-hits
    std::cout << seed_max / (double)save_k_mer.size() << std::endl;

    // DR-Score
    // std::cout << seed_max / (double)save_k_mer.size() << std::endl;
    std::cout << (save_k_mer.size() * k_mer_win / (double)s_kmer_sum) * seed_max / (double)save_k_mer.size() << std::endl;
    return 0;
}
